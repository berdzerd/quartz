...
| Korean            | English                                                   | Example |
| ----------------- | --------------------------------------------------------- | ------- |
| 윗사람에게 반말을 하다      | to speak casually (impolitely) to a supervisor            |         |
| 한 손으로 물건을 드리다     | to give something with one hand (to a superior)           |         |
| 글자를 잘못 읽다         | to misread a letter/character                             |         |
| 노약자석              | priority seat (for the elderly, pregnant, disabled, etc.) |         |
| 높임말을 잘못 사용하다      | to misuse honorific language                              |         |
| 한국 사람 이야기를 못 알아듣다 | to not understand what a Korean person is saying          |         |
| 잘못 발음하다           | to mispronounce                                           |         |
| 사람을 잘못 보다         | to misjudge a person                                      |         |
| 윗사람의 이름을 부르다      | to call a superior by their name                          |         |
| 신발을 신고 들어가다       | to enter while wearing shoes                              |         |
